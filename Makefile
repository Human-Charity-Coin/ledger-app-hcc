...
APPNAME ="Quebecoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),humancharitycoin)
# Qbc
DEFINES   += BIP44_COIN_TYPE=3 BIP44_COIN_TYPE_2=3 COIN_P2PKH_VERSION=40 COIN_P2SH_VERSION=28 COIN_FAMILY=1 COIN_COINID=\"HumanCharitycoin\" COIN_COINID_HEADER=\"HUMANCHARITYCOIN\" COIN_COLOR_HDR=0x65D196 COIN_COLOR_DB=0xB2E8CB COIN_COINID_NAME=\"HumanCharitycoin\" COIN_COINID_SHORT=\"HCC\" COIN_KIND=COIN_KIND_HCC
APPNAME ="HumanCharitycoin"
APP_LOAD_PARAMS += --path $(APP_PATH)
else ifeq ($(COIN),dash)
# Dash
